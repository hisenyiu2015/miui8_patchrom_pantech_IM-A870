.class public Lbluros/app/CMTelephonyManager;
...
.field private static sCMTelephonyManagerInstance:Lbluros/app/CMTelephonyManager;

.field private static sService:Lbluros/app/ICMTelephonyManager;
...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lbluros/app/CMTelephonyManager;->localLOGD:Z
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    .line 55
    iput-object v0, p0, Lbluros/app/CMTelephonyManager;->mContext:Landroid/content/Context;

    .line 59
    :goto_0
    invoke-virtual {p0}, Lbluros/app/CMTelephonyManager;->getService()Lbluros/app/ICMTelephonyManager;

    move-result-object v1

    sput-object v1, Lbluros/app/CMTelephonyManager;->sService:Lbluros/app/ICMTelephonyManager;
    ...
    const-string/jumbo v2, "org.bluros.telephony"
    ...
    .line 62
    sget-object v1, Lbluros/app/CMTelephonyManager;->sService:Lbluros/app/ICMTelephonyManager;
    ...
    .line 57
    :cond_1
    iput-object p1, p0, Lbluros/app/CMTelephonyManager;->mContext:Landroid/content/Context;

    goto :goto_0
.end method

.method public static getInstance(Landroid/content/Context;)Lbluros/app/CMTelephonyManager;
    .locals 1
    .param p0, "context"    # Landroid/content/Context;

    .prologue
    .line 75
    sget-object v0, Lbluros/app/CMTelephonyManager;->sCMTelephonyManagerInstance:Lbluros/app/CMTelephonyManager;

    if-nez v0, :cond_0

    .line 76
    new-instance v0, Lbluros/app/CMTelephonyManager;

    invoke-direct {v0, p0}, Lbluros/app/CMTelephonyManager;-><init>(Landroid/content/Context;)V

    sput-object v0, Lbluros/app/CMTelephonyManager;->sCMTelephonyManagerInstance:Lbluros/app/CMTelephonyManager;
...
# virtual methods
.method public getService()Lbluros/app/ICMTelephonyManager;
    .locals 3
    ...
    .line 88
    invoke-static {v0}, Lbluros/app/ICMTelephonyManager$Stub;->asInterface(Landroid/os/IBinder;)Lbluros/app/ICMTelephonyManager;
...
.method public getSubInformation()Ljava/util/List;
    ...
    .line 102
    sget-object v3, Lbluros/app/CMTelephonyManager;->sService:Lbluros/app/ICMTelephonyManager;
    ...
    .line 107
    :cond_0
    sget-boolean v3, Lbluros/app/CMTelephonyManager;->localLOGD:Z

    if-eqz v3, :cond_1

    .line 108
    iget-object v3, p0, Lbluros/app/CMTelephonyManager;->mContext:Landroid/content/Context;
    ...
    invoke-interface {v3}, Lbluros/app/ICMTelephonyManager;->getSubInformation()Ljava/util/List;
...
.method public isDataConnectionEnabled()Z
    ...
    invoke-interface {v3}, Lbluros/app/ICMTelephonyManager;->isDataConnectionEnabled()Z
...
.method public isDataConnectionSelectedOnSub(I)Z
    ...
    invoke-interface {v3, p1}, Lbluros/app/ICMTelephonyManager;->isDataConnectionSelectedOnSub(I)Z
...
.method public isSubActive(I)Z
    ...
    invoke-interface {v3, p1}, Lbluros/app/ICMTelephonyManager;->isSubActive(I)Z
...
.method public setDataConnectionSelectedOnSub(I)V
    ...
    .prologue
    .line 288
    sget-object v2, Lbluros/app/CMTelephonyManager;->sService:Lbluros/app/ICMTelephonyManager;
    ...
    .line 293
    :cond_0
    sget-boolean v2, Lbluros/app/CMTelephonyManager;->localLOGD:Z

    if-eqz v2, :cond_1

    .line 294
    iget-object v2, p0, Lbluros/app/CMTelephonyManager;->mContext:Landroid/content/Context;
    ...
    invoke-interface {v2, p1}, Lbluros/app/ICMTelephonyManager;->setDataConnectionSelectedOnSub(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setDataConnectionState(Z)V
    ...
    invoke-interface {v2, p1}, Lbluros/app/ICMTelephonyManager;->setDataConnectionState(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setDefaultPhoneSub(I)V
    ...
    invoke-interface {v2, p1}, Lbluros/app/ICMTelephonyManager;->setDefaultPhoneSub(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setDefaultSmsSub(I)V
    ...
    invoke-interface {v2, p1}, Lbluros/app/ICMTelephonyManager;->setDefaultSmsSub(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setSubState(IZ)V
    ...
    invoke-interface {v2, p1, p2}, Lbluros/app/ICMTelephonyManager;->setSubState(IZ)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
