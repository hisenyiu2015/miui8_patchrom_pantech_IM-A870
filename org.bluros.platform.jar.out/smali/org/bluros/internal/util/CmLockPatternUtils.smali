.class public Lorg/bluros/internal/util/CmLockPatternUtils;
.super Lcom/android/internal/widget/LockPatternUtils;
.source "CmLockPatternUtils.java"


# static fields
.field public static final ACTION_THIRD_PARTY_KEYGUARD_COMPONENT_CHANGED:Ljava/lang/String; = "org.bluros.internal.action.THIRD_PARTY_KEYGUARD_COMPONENT_CHANGED"
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 47
    iput-object p1, p0, Lorg/bluros/internal/util/CmLockPatternUtils;->mContext:Landroid/content/Context;
...
.method public getThirdPartyKeyguardComponent()Landroid/content/ComponentName;
    ...
    invoke-direct {p0}, Lorg/bluros/internal/util/CmLockPatternUtils;->getCurrentUser()I

    move-result v3

    invoke-virtual {p0, v2, v3}, Lorg/bluros/internal/util/CmLockPatternUtils;->getString(Ljava/lang/String;I)Ljava/lang/String;
...
.method public isThirdPartyKeyguardEnabled()Z
    ...
    invoke-virtual {p0, v1, v2}, Lorg/bluros/internal/util/CmLockPatternUtils;->getString(Ljava/lang/String;I)Ljava/lang/String;
...
.method public setPassToSecurityView(ZI)V
    ...
    invoke-virtual {p0, v0, p1, p2}, Lorg/bluros/internal/util/CmLockPatternUtils;->setBoolean(Ljava/lang/String;ZI)V
...
.method public setThirdPartyKeyguard(Landroid/content/ComponentName;)V
    ...
    .line 58
    iget-object v2, p0, Lorg/bluros/internal/util/CmLockPatternUtils;->mContext:Landroid/content/Context;
    ...
    .line 68
    invoke-virtual {p0, v3, v2, v4}, Lorg/bluros/internal/util/CmLockPatternUtils;->setString(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    const-string/jumbo v4, "org.bluros.internal.action.THIRD_PARTY_KEYGUARD_COMPONENT_CHANGED"
...
.method public shouldPassToSecurityView(I)Z
    ...
    invoke-virtual {p0, v0, v1, p1}, Lorg/bluros/internal/util/CmLockPatternUtils;->getBoolean(Ljava/lang/String;ZI)Z
