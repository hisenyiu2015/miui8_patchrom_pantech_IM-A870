.class public Lorg/bluros/internal/util/ImageUtils;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 40
    const-class v0, Lorg/bluros/internal/util/ImageUtils;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lorg/bluros/internal/util/ImageUtils;->TAG:Ljava/lang/String;
...
.method public static cropImage(Ljava/io/InputStream;IIII)Ljava/io/InputStream;
    ...
    sget-object v14, Lorg/bluros/internal/util/ImageUtils;->TAG:Ljava/lang/String;
...
.method public static getCroppedKeyguardStream(Ljava/lang/String;Landroid/content/Context;)Ljava/io/InputStream;
    ...
    :try_start_0
    invoke-static {p0, p1}, Lorg/bluros/internal/util/ImageUtils;->getOriginalKeyguardStream(Ljava/lang/String;Landroid/content/Context;)Ljava/io/InputStream;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_2
    :try_start_1
    invoke-static {v5}, Lorg/bluros/internal/util/ImageUtils;->getImageDimension(Ljava/io/InputStream;)Landroid/graphics/Point;
    ...
    invoke-static {v5, v7, v8, v3, v2}, Lorg/bluros/internal/util/ImageUtils;->cropImage(Ljava/io/InputStream;IIII)Ljava/io/InputStream;
    :try_end_3
    ...
    :try_start_4
    sget-object v7, Lorg/bluros/internal/util/ImageUtils;->TAG:Ljava/lang/String;
...
.method public static getCroppedWallpaperStream(Ljava/lang/String;JLandroid/content/Context;)Ljava/io/InputStream;
    ...
    .local v5, "stream":Ljava/io/InputStream;
    :try_start_0
    invoke-static {p0, p1, p2, p3}, Lorg/bluros/internal/util/ImageUtils;->getOriginalWallpaperStream(Ljava/lang/String;JLandroid/content/Context;)Ljava/io/InputStream;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private static getOriginalKeyguardStream(Ljava/lang/String;Landroid/content/Context;)Ljava/io/InputStream;
    ...
    invoke-static {v0}, Lorg/bluros/internal/util/ThemeUtils;->getLockscreenWallpaperPath(Landroid/content/res/AssetManager;)Ljava/lang/String;
    ...
    .line 233
    sget-object v5, Lorg/bluros/internal/util/ImageUtils;->TAG:Ljava/lang/String;
    ...
    .line 235
    invoke-static {v3, v5}, Lorg/bluros/internal/util/ThemeUtils;->getInputStreamFromAsset(Landroid/content/Context;Ljava/lang/String;)Ljava/io/InputStream;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private static getOriginalWallpaperStream(Ljava/lang/String;JLandroid/content/Context;)Ljava/io/InputStream;
    ...
    sget-object v5, Lbluros/providers/ThemesContract$ThemesColumns;->CONTENT_URI:Landroid/net/Uri;
    ...
    invoke-static {v15, v0}, Lorg/bluros/internal/util/ThemeUtils;->getInputStreamFromAsset(Landroid/content/Context;Ljava/lang/String;)Ljava/io/InputStream;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-static {v0, v1, v2, v3}, Lorg/bluros/internal/util/ImageUtils;->queryWpPathFromComponentId(Landroid/content/Context;Ljava/lang/String;J)Ljava/lang/String;
    ...
    invoke-static {v10}, Lorg/bluros/internal/util/ThemeUtils;->getWallpaperPath(Landroid/content/res/AssetManager;)Ljava/lang/String;
    ...
    .line 286
    sget-object v4, Lorg/bluros/internal/util/ImageUtils;->TAG:Ljava/lang/String;
    ...
    invoke-static {v0, v4}, Lorg/bluros/internal/util/ThemeUtils;->getInputStreamFromAsset(Landroid/content/Context;Ljava/lang/String;)Ljava/io/InputStream;
    :try_end_3
    .catch Ljava/lang/Exception; {:try_start_3 .. :try_end_3} :catch_0
    .catchall {:try_start_3 .. :try_end_3} :catchall_0
...
.method private static queryWpPathFromComponentId(Landroid/content/Context;Ljava/lang/String;J)Ljava/lang/String;
    ...
    .line 315
    sget-object v1, Lbluros/providers/ThemesContract$PreviewColumns;->COMPONENTS_URI:Landroid/net/Uri;
    ...
    :try_start_1
    sget-object v0, Lorg/bluros/internal/util/ImageUtils;->TAG:Ljava/lang/String;
