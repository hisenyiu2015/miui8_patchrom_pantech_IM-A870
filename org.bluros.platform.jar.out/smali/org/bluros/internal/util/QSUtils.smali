.class public Lorg/bluros/internal/util/QSUtils;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lorg/bluros/internal/util/QSUtils$OnQSChanged;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/bluros/internal/util/QSUtils;->sSystemUiContextForUser:Landroid/util/SparseArray;
...
.method public static deviceSupportsPowerProfiles(Landroid/content/Context;)Z
    ...
    .line 305
    invoke-static {p0}, Lbluros/power/PerformanceManager;->getInstance(Landroid/content/Context;)Lbluros/power/PerformanceManager;

    move-result-object v0

    .line 306
    .local v0, "pm":Lbluros/power/PerformanceManager;
    invoke-virtual {v0}, Lbluros/power/PerformanceManager;->getNumberOfProfiles()I
...
.method private static filterTiles(Landroid/content/Context;)V
    ...
    .prologue
    .line 145
    sget-boolean v0, Lorg/bluros/internal/util/QSUtils;->sAvailableTilesFiltered:Z

    if-nez v0, :cond_0

    .line 146
    sget-object v0, Lorg/bluros/internal/util/QSConstants;->TILES_AVAILABLE:Ljava/util/ArrayList;

    invoke-static {p0, v0}, Lorg/bluros/internal/util/QSUtils;->filterTiles(Landroid/content/Context;Ljava/util/List;)V

    .line 147
    const/4 v0, 0x1

    sput-boolean v0, Lorg/bluros/internal/util/QSUtils;->sAvailableTilesFiltered:Z
...
.method private static filterTiles(Landroid/content/Context;Ljava/util/List;)V
    ...
    invoke-static {p0}, Lorg/bluros/internal/util/QSUtils;->deviceSupportsMobileData(Landroid/content/Context;)Z
    ...
    .line 114
    invoke-static {p0}, Lorg/bluros/internal/util/QSUtils;->deviceSupportsDdsSupported(Landroid/content/Context;)Z
    ...
    .line 117
    invoke-static {p0}, Lorg/bluros/internal/util/QSUtils;->deviceSupportsFlashLight(Landroid/content/Context;)Z
    ...
    .line 120
    invoke-static {}, Lorg/bluros/internal/util/QSUtils;->deviceSupportsBluetooth()Z
    ...
    .line 123
    invoke-static {p0}, Lorg/bluros/internal/util/QSUtils;->deviceSupportsNfc(Landroid/content/Context;)Z
    ...
    .line 126
    invoke-static {p0}, Lorg/bluros/internal/util/QSUtils;->deviceSupportsCompass(Landroid/content/Context;)Z
    ...
    .line 129
    invoke-static {p0}, Lorg/bluros/internal/util/QSUtils;->deviceSupportsDoze(Landroid/content/Context;)Z
    ...
    .line 132
    invoke-static {p0}, Lorg/bluros/internal/util/QSUtils;->deviceSupportsPowerProfiles(Landroid/content/Context;)Z
...
.method public static getAvailableTiles(Landroid/content/Context;)Ljava/util/List;
    ...
    .prologue
    .line 71
    invoke-static {p0}, Lorg/bluros/internal/util/QSUtils;->filterTiles(Landroid/content/Context;)V
...
.method public static getDefaultTiles(Landroid/content/Context;)Ljava/util/List;
    ...
    :cond_1
    invoke-static {p0, v3}, Lorg/bluros/internal/util/QSUtils;->filterTiles(Landroid/content/Context;Ljava/util/List;)V
...
.method public static getDefaultTilesAsString(Landroid/content/Context;)Ljava/lang/String;
    ...
    .prologue
    .line 93
    invoke-static {p0}, Lorg/bluros/internal/util/QSUtils;->getDefaultTiles(Landroid/content/Context;)Ljava/util/List;
...
.method public static getDynamicQSTileLabel(Landroid/content/Context;ILjava/lang/String;)Ljava/lang/String;
    ...
    .line 171
    invoke-static {p0, p1}, Lorg/bluros/internal/util/QSUtils;->getQSTileContext(Landroid/content/Context;I)Landroid/content/Context;

    move-result-object v0

    .line 172
    .local v0, "ctx":Landroid/content/Context;
    invoke-static {v0, p2}, Lorg/bluros/internal/util/QSUtils;->translateDynamicQsTileSpecToIndex(Landroid/content/Context;Ljava/lang/String;)I
...
.method public static getQSTileContext(Landroid/content/Context;I)Landroid/content/Context;
    ...
    .prologue
    .line 200
    sget-object v2, Lorg/bluros/internal/util/QSUtils;->sSystemUiContextForUser:Landroid/util/SparseArray;
...
.method public static isDynamicQsTile(Ljava/lang/String;)Z
    ...
    .prologue
    .line 66
    sget-object v0, Lorg/bluros/internal/util/QSConstants;->DYNAMIC_TILES_AVAILBLE:Ljava/util/ArrayList;
...
.method public static isQSTileEnabledForUser(Landroid/content/Context;Ljava/lang/String;I)Z
    ...
    .line 216
    invoke-static {v1, v2, p2}, Lbluros/providers/CMSettings$Secure;->getStringForUser(Landroid/content/ContentResolver;Ljava/lang/String;I)Ljava/lang/String;
...
.method public static isStaticQsTile(Ljava/lang/String;)Z
    ...
    .prologue
    .line 62
    sget-object v0, Lorg/bluros/internal/util/QSConstants;->STATIC_TILES_AVAILABLE:Ljava/util/ArrayList;
...
.method public static registerObserverForQSChanges(Landroid/content/Context;Lorg/bluros/internal/util/QSUtils$OnQSChanged;)Landroid/database/ContentObserver;
    .locals 5
    .param p0, "ctx"    # Landroid/content/Context;
    .param p1, "cb"    # Lorg/bluros/internal/util/QSUtils$OnQSChanged;

    .prologue
    .line 222
    new-instance v0, Lorg/bluros/internal/util/QSUtils$1;

    new-instance v1, Landroid/os/Handler;

    invoke-direct {v1}, Landroid/os/Handler;-><init>()V

    invoke-direct {v0, v1, p1}, Lorg/bluros/internal/util/QSUtils$1;-><init>(Landroid/os/Handler;Lorg/bluros/internal/util/QSUtils$OnQSChanged;)V
