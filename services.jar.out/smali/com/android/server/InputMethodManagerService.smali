...
# direct methods
.method static synthetic -get0(Lcom/android/server/InputMethodManagerService;)Lbluros/hardware/CMHardwareManager;
    .locals 1

    iget-object v0, p0, Lcom/android/server/InputMethodManagerService;->mCMHardware:Lbluros/hardware/CMHardwareManager;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/WindowManagerService;)V
    ...
    iput-object v0, p0, Lcom/android/server/InputMethodManagerService;->mQSListener:Lorg/bluros/internal/util/QSUtils$OnQSChanged;
    ...
    iget-object v1, p0, Lcom/android/server/InputMethodManagerService;->mQSListener:Lorg/bluros/internal/util/QSUtils$OnQSChanged;

    invoke-static {v0, v1}, Lorg/bluros/internal/util/QSUtils;->registerObserverForQSChanges(Landroid/content/Context;Lorg/bluros/internal/util/QSUtils$OnQSChanged;)Landroid/database/ContentObserver;
...
.method private publishImeSelectorCustomTile(Landroid/view/inputmethod/InputMethodInfo;)V
    ...
    .line 3637
    invoke-static {v11, v10, v12}, Lorg/bluros/internal/util/QSUtils;->getDynamicQSTileResIconId(Landroid/content/Context;ILjava/lang/String;)I
    ...
    .line 3639
    invoke-static {v11, v10, v12}, Lorg/bluros/internal/util/QSUtils;->getDynamicQSTileLabel(Landroid/content/Context;ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v11, v10}, Lorg/bluros/internal/util/QSUtils;->getQSTileContext(Landroid/content/Context;I)Landroid/content/Context;
    ...
    invoke-static {v11}, Lbluros/app/CMStatusBarManager;->getInstance(Landroid/content/Context;)Lbluros/app/CMStatusBarManager;

    move-result-object v5

    .line 3650
    .local v5, "statusBarManager":Lbluros/app/CMStatusBarManager;
    new-instance v11, Lbluros/app/CustomTile$Builder;

    invoke-direct {v11, v4}, Lbluros/app/CustomTile$Builder;-><init>(Landroid/content/Context;)V
    ...
    .line 3650
    invoke-virtual {v11, v12}, Lbluros/app/CustomTile$Builder;->setLabel(Ljava/lang/String;)Lbluros/app/CustomTile$Builder;

    move-result-object v11

    invoke-virtual {v11, v0}, Lbluros/app/CustomTile$Builder;->setContentDescription(Ljava/lang/String;)Lbluros/app/CustomTile$Builder;

    move-result-object v11

    invoke-virtual {v11, v1}, Lbluros/app/CustomTile$Builder;->setIcon(I)Lbluros/app/CustomTile$Builder;
    ...
    .line 3650
    invoke-virtual {v11, v12}, Lbluros/app/CustomTile$Builder;->setOnClickIntent(Landroid/app/PendingIntent;)Lbluros/app/CustomTile$Builder;

    move-result-object v11

    invoke-virtual {v11}, Lbluros/app/CustomTile$Builder;->build()Lbluros/app/CustomTile;

    move-result-object v6

    .line 3656
    .local v6, "tile":Lbluros/app/CustomTile;
    ...
    .line 3656
    invoke-virtual {v5, v11, v12, v6, v7}, Lbluros/app/CMStatusBarManager;->publishTileAsUser(Ljava/lang/String;ILbluros/app/CustomTile;Landroid/os/UserHandle;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .end local v5    # "statusBarManager":Lbluros/app/CMStatusBarManager;
    .end local v6    # "tile":Lbluros/app/CustomTile;
    :cond_1
    move-object v3, v2
...
.method private updateTouchHovering()V
    ...
    .line 2011
    iget-object v1, p0, Lcom/android/server/InputMethodManagerService;->mCMHardware:Lbluros/hardware/CMHardwareManager;

    invoke-virtual {v1, v4}, Lbluros/hardware/CMHardwareManager;->isSupported(I)Z
    ...
    .line 2014
    invoke-static {v1, v2, v3}, Lbluros/providers/CMSettings$Secure;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    invoke-virtual {v1, v4, v0}, Lbluros/hardware/CMHardwareManager;->set(IZ)Z
...
.method public systemRunning(Lcom/android/server/statusbar/StatusBarManagerService;)V
    ...
    iput-object v1, p0, Lcom/android/server/InputMethodManagerService;->mCMHardware:Lbluros/hardware/CMHardwareManager;
...
.method updateInputMethodsFromSettingsLocked(Z)V
    ...
    .line 1986
    invoke-static {v0, v1}, Lbluros/providers/CMSettings$System;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;)I
    ...
    iput-boolean v0, p0, Lcom/android/server/InputMethodManagerService;->mShowOngoingImeSwitcherForPhones:Z
    :try_end_2
    .catch Lbluros/providers/CMSettings$CMSettingNotFoundException; {:try_start_2 .. :try_end_2} :catch_1
    ...
    .line 1989
    .local v8, "e":Lbluros/providers/CMSettings$CMSettingNotFoundException;
    ...
    .line 1959
    .end local v8    # "e":Lbluros/providers/CMSettings$CMSettingNotFoundException;
