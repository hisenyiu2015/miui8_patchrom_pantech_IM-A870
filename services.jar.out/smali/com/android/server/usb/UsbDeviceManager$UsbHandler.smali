...
.method public constructor <init>(Lcom/android/server/usb/UsbDeviceManager;Landroid/os/Looper;)V
    ...
    invoke-static {v4}, Lbluros/providers/CMSettings$Secure;->getUriFor(Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-static {p1}, Lcom/android/server/usb/UsbDeviceManager;->-get13(Lcom/android/server/usb/UsbDeviceManager;)Lorg/bluros/internal/util/QSUtils$OnQSChanged;
...
.method private getAdbCustomTileLabel()Ljava/lang/String;
    ...
    invoke-static {v4, v5, v6}, Lbluros/providers/CMSettings$Secure;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
...
.method private processQSChangedLocked()V
    ...
    invoke-static {v6, v7, v8}, Lbluros/providers/CMSettings$Secure;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    .line 1000
    invoke-static {v6, v7, v9}, Lbluros/providers/CMSettings$Secure;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
...
.method private publishAdbCustomTile()V
    ...
    .line 935
    invoke-static {v9, v8, v10}, Lorg/bluros/internal/util/QSUtils;->getDynamicQSTileResIconId(Landroid/content/Context;ILjava/lang/String;)I
    ...
    .line 937
    invoke-static {v9, v8, v10}, Lorg/bluros/internal/util/QSUtils;->getDynamicQSTileLabel(Landroid/content/Context;ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v9, v8}, Lorg/bluros/internal/util/QSUtils;->getQSTileContext(Landroid/content/Context;I)Landroid/content/Context;
    ...
    invoke-static {v9}, Lbluros/app/CMStatusBarManager;->getInstance(Landroid/content/Context;)Lbluros/app/CMStatusBarManager;

    move-result-object v3

    .line 942
    .local v3, "statusBarManager":Lbluros/app/CMStatusBarManager;
    new-instance v9, Lbluros/app/CustomTile$Builder;

    invoke-direct {v9, v2}, Lbluros/app/CustomTile$Builder;-><init>(Landroid/content/Context;)V
    ...
    .line 942
    invoke-virtual {v9, v10}, Lbluros/app/CustomTile$Builder;->setLabel(Ljava/lang/String;)Lbluros/app/CustomTile$Builder;

    move-result-object v9

    invoke-virtual {v9, v0}, Lbluros/app/CustomTile$Builder;->setContentDescription(Ljava/lang/String;)Lbluros/app/CustomTile$Builder;

    move-result-object v9

    invoke-virtual {v9, v1}, Lbluros/app/CustomTile$Builder;->setIcon(I)Lbluros/app/CustomTile$Builder;
    ...
    .line 942
    invoke-virtual {v9, v10}, Lbluros/app/CustomTile$Builder;->setOnClickIntent(Landroid/app/PendingIntent;)Lbluros/app/CustomTile$Builder;

    move-result-object v9

    invoke-virtual {v9}, Lbluros/app/CustomTile$Builder;->build()Lbluros/app/CustomTile;

    move-result-object v4

    .line 948
    .local v4, "tile":Lbluros/app/CustomTile;
    ...
    .line 948
    invoke-virtual {v3, v9, v10, v4, v5}, Lbluros/app/CMStatusBarManager;->publishTileAsUser(Ljava/lang/String;ILbluros/app/CustomTile;Landroid/os/UserHandle;)V
    :try_end_0
    ...
    .end local v3    # "statusBarManager":Lbluros/app/CMStatusBarManager;
    .end local v4    # "tile":Lbluros/app/CustomTile;
...
.method private updateAdbNotification()V
    ...
    invoke-static {v0, v1, v3}, Lbluros/providers/CMSettings$Secure;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
