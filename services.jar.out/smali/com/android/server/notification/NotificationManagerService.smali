...
.method private generateLedColorForNotification(Lcom/android/server/notification/NotificationRecord;)I
    ...
    invoke-static {v2}, Lbluros/util/ColorUtils;->generateAlertColorFromDrawable(Landroid/graphics/drawable/Drawable;)I
...
.method private updateDisableDucking()V
    ...
    const-string/jumbo v2, "bluros.intent.action.ACTION_AUDIO_SESSIONS_CHANGED"
...
.method private updateForActiveSessions()V
    ...
    invoke-static {v4}, Lbluros/media/CMAudioManager;->getInstance(Landroid/content/Context;)Lbluros/media/CMAudioManager;

    move-result-object v0

    .line 1121
    .local v0, "manager":Lbluros/media/CMAudioManager;
    const/4 v4, 0x3

    invoke-virtual {v0, v4}, Lbluros/media/CMAudioManager;->listAudioSessions(I)Ljava/util/List;
    ...
    .line 1124
    .local v1, "sessionInfo":Lbluros/media/AudioSessionInfo;
    invoke-virtual {v1}, Lbluros/media/AudioSessionInfo;->getSessionId()I
    ...
    .line 1119
    .end local v1    # "sessionInfo":Lbluros/media/AudioSessionInfo;
    :cond_1
    return-void
.end method
