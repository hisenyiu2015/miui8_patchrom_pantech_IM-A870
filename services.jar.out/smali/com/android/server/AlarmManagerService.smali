...
.field private final mQSListener:Lorg/bluros/internal/util/QSUtils$OnQSChanged;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/server/AlarmManagerService;->mQSListener:Lorg/bluros/internal/util/QSUtils$OnQSChanged;
...
.method private publishNextAlarmCustomTile(I)V
    ...
    invoke-static {v0, v1, v2}, Lorg/bluros/internal/util/QSUtils;->getDynamicQSTileResIconId(Landroid/content/Context;ILjava/lang/String;)I
    ...
    invoke-static {v0, v1, v2}, Lorg/bluros/internal/util/QSUtils;->getDynamicQSTileLabel(Landroid/content/Context;ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lorg/bluros/internal/util/QSUtils;->getQSTileContext(Landroid/content/Context;I)Landroid/content/Context;
    ...
    new-instance v14, Lbluros/app/CustomTile$ListExpandedStyle;

    invoke-direct {v14}, Lbluros/app/CustomTile$ListExpandedStyle;-><init>()V

    .line 2697
    .local v14, "style":Lbluros/app/CustomTile$ListExpandedStyle;
    new-instance v9, Ljava/util/ArrayList;

    invoke-direct {v9}, Ljava/util/ArrayList;-><init>()V

    .line 2698
    .local v9, "items":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lbluros/app/CustomTile$ExpandedListItem;>;"
    ...
    new-instance v8, Lbluros/app/CustomTile$ExpandedListItem;

    invoke-direct {v8}, Lbluros/app/CustomTile$ExpandedListItem;-><init>()V

    .line 2705
    .local v8, "item":Lbluros/app/CustomTile$ExpandedListItem;
    invoke-virtual {v8, v7}, Lbluros/app/CustomTile$ExpandedListItem;->setExpandedListItemDrawable(I)V
    ...
    invoke-virtual {v8, v0}, Lbluros/app/CustomTile$ExpandedListItem;->setExpandedListItemTitle(Ljava/lang/String;)V
    ...
    invoke-virtual {v8, v0}, Lbluros/app/CustomTile$ExpandedListItem;->setExpandedListItemSummary(Ljava/lang/String;)V
    ...
    invoke-virtual {v8, v0}, Lbluros/app/CustomTile$ExpandedListItem;->setExpandedListItemOnClickIntent(Landroid/app/PendingIntent;)V
    ...
    .end local v7    # "icon":I
    .end local v8    # "item":Lbluros/app/CustomTile$ExpandedListItem;
    .end local v9    # "items":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lbluros/app/CustomTile$ExpandedListItem;>;"
    .end local v11    # "pkg":Ljava/lang/String;
    .end local v12    # "resourceContext":Landroid/content/Context;
    .end local v14    # "style":Lbluros/app/CustomTile$ListExpandedStyle;
    ...
    .restart local v9    # "items":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lbluros/app/CustomTile$ExpandedListItem;>;"
    .restart local v12    # "resourceContext":Landroid/content/Context;
    .restart local v14    # "style":Lbluros/app/CustomTile$ListExpandedStyle;
    .restart local v18    # "user":Landroid/os/UserHandle;
    :cond_1
    :try_start_1
    invoke-virtual {v14, v9}, Lbluros/app/CustomTile$ListExpandedStyle;->setListItems(Ljava/util/ArrayList;)V
    :try_end_1
    ...
    invoke-static/range {v19 .. v19}, Lbluros/app/CMStatusBarManager;->getInstance(Landroid/content/Context;)Lbluros/app/CMStatusBarManager;

    move-result-object v13

    .line 2720
    .local v13, "statusBarManager":Lbluros/app/CMStatusBarManager;
    new-instance v19, Lbluros/app/CustomTile$Builder;

    move-object/from16 v0, v19

    invoke-direct {v0, v12}, Lbluros/app/CustomTile$Builder;-><init>(Landroid/content/Context;)V
    ...
    .line 2720
    invoke-virtual/range {v19 .. v20}, Lbluros/app/CustomTile$Builder;->setLabel(Ljava/lang/String;)Lbluros/app/CustomTile$Builder;

    move-result-object v19

    move-object/from16 v0, v19

    invoke-virtual {v0, v6}, Lbluros/app/CustomTile$Builder;->setContentDescription(Ljava/lang/String;)Lbluros/app/CustomTile$Builder;

    move-result-object v19

    move-object/from16 v0, v19

    invoke-virtual {v0, v7}, Lbluros/app/CustomTile$Builder;->setIcon(I)Lbluros/app/CustomTile$Builder;

    move-result-object v19

    move-object/from16 v0, v19

    invoke-virtual {v0, v14}, Lbluros/app/CustomTile$Builder;->setExpandedStyle(Lbluros/app/CustomTile$ExpandedStyle;)Lbluros/app/CustomTile$Builder;

    move-result-object v19

    invoke-virtual/range {v19 .. v19}, Lbluros/app/CustomTile$Builder;->build()Lbluros/app/CustomTile;

    move-result-object v15

    .line 2726
    .local v15, "tile":Lbluros/app/CustomTile;
    ...
    invoke-virtual {v13, v0, v1, v15, v2}, Lbluros/app/CMStatusBarManager;->publishTileAsUser(Ljava/lang/String;ILbluros/app/CustomTile;Landroid/os/UserHandle;)V
    :try_end_2
...
.method private unpublishNextAlarmCustomTile(I)V
    ...
    invoke-static {v1}, Lbluros/app/CMStatusBarManager;->getInstance(Landroid/content/Context;)Lbluros/app/CMStatusBarManager;
    ...
    .line 2738
    invoke-virtual {v0, v1, v4, v5}, Lbluros/app/CMStatusBarManager;->removeTileAsUser(Ljava/lang/String;ILandroid/os/UserHandle;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method protected finalize()V
    ...
    invoke-static {v1, v2}, Lorg/bluros/internal/util/QSUtils;->unregisterObserverForQSChanges(Landroid/content/Context;Landroid/database/ContentObserver;)V
    :try_end_0
...
.method public onStart()V
    ...
    iget-object v4, p0, Lcom/android/server/AlarmManagerService;->mQSListener:Lorg/bluros/internal/util/QSUtils$OnQSChanged;

    invoke-static {v3, v4}, Lorg/bluros/internal/util/QSUtils;->registerObserverForQSChanges(Landroid/content/Context;Lorg/bluros/internal/util/QSUtils$OnQSChanged;)Landroid/database/ContentObserver;
