...
.method public getBandCount([I)I
    ...
    :try_start_0
    const-string/jumbo v3, "android.dolby.IDs"
...
.method public registerCallback(Landroid/dolby/IDsServiceCallbacks;I)V
    .locals 5
    .param p1, "cb"    # Landroid/dolby/IDsServiceCallbacks;
    .param p2, "handle"    # I
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public registerDsApParamEvents(I)V
    ...
    .local v1, "_reply":Landroid/os/Parcel;
    :try_start_0
    const-string/jumbo v2, "android.dolby.IDs"
...
.method public resetProfile(II)I
    .locals 6
    .param p1, "handle"    # I
    .param p2, "profile"    # I
    .annotation system Ldalvik/annotation/Throws;
...
.method public setDsApParam(ILjava/lang/String;[I)I
    .locals 6
    .param p1, "handle"    # I
...
.method public setDsOn(IZ)I
    ...
    .local v1, "_reply":Landroid/os/Parcel;
    :try_start_0
    const-string/jumbo v5, "android.dolby.IDs"
...
.method public setGeq(III[F)I
    .locals 6
    .param p1, "handle"    # I
    .param p2, "profile"    # I
    .param p3, "preset"    # I
    .param p4, "geqBandGains"    # [F
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
...
.method public setIeqPreset(III)I
    .locals 6
    .param p1, "handle"    # I
    .param p2, "profile"    # I
    .param p3, "preset"    # I
...
.method public setNonPersistentMode(Z)I
    ...
    .local v1, "_reply":Landroid/os/Parcel;
    :try_start_0
    const-string/jumbo v4, "android.dolby.IDs"
...
.method public setProfileName(IILjava/lang/String;)I
    .locals 6
    .param p1, "handle"    # I
    .param p2, "profile"    # I
...
.method public setProfileSettings(IILandroid/dolby/DsClientSettings;)I
    .locals 6
    .param p1, "handle"    # I
    .param p2, "profile"    # I
    .param p3, "settings"    # Landroid/dolby/DsClientSettings;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
        }
    ...
    invoke-virtual {p3, v0, v3}, Landroid/dolby/DsClientSettings;->writeToParcel(Landroid/os/Parcel;I)V
...
.method public setSelectedProfile(II)I
    .locals 6
    .param p1, "handle"    # I
    .param p2, "profile"    # I
    .annotation system Ldalvik/annotation/Throws;
